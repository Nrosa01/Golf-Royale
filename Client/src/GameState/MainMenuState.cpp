...
MainMenuState::MainMenuState(SDLApp *app) : GameState(app)
{
    ...
    playButton->aAddComponent(new Button(app->getTexture("button"), "Jugar", "toonFont", 72,
        [this]()
        {
    ...
    exitButton->aAddComponent(new Button(app->getTexture("button"), "Salir", "toonFont", 72, [this]()
